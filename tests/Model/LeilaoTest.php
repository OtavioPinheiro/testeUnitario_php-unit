...
class LeilaoTest extends TestCase
{
     ...
     */
    public function testLeilaoDeveReceberLances(int $qtdeLances, Leilao $leilao, array $valores): void
    {
    ...
    public static function geraLances(): array
    {
        ...
        return [
            "Leilão com dois lances" => [2, $leilaoCom2Lances, [1000, 2000]],
            "Leilão com um lance" => [1, $leilaoCom1Lance, [5000]]
        ];
    }
}